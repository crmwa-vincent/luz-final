...
else if(isset($_SESSION['usertype']) && $_SESSION['usertype'] == 1)
{
	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			<ul class="nav nav-tabs">
			  <li class="active"><a href="#user" data-toggle="tab">Add User</a></li>
			  <li class=""><a href="#display" data-toggle="tab">Display List of Users</a></li>
			</ul>
			<div id="myTabContent" class="tab-content">
			  <div class="tab-pane fade active in" id="user">
			<form action="action/register-action.php" method="POST" role="form">
					<table class="table table-striped table-hover">
						<thead><tr><td colspan="2" align="center"><h1 class="text-success">Register a User</h1></td><td></td></tr></thead>
						<tbody>
						<tr><td>First Name: </td><td><input type="text" class="form-control" placeholder="Enter User First Name" name="cfname" id="inputDefault" required/></td></tr>
						<tr><td>Lastname: </td><td><input type="text" class="form-control" placeholder="Enter User Last Name" name="clname" id="inputDefault" required/></td></tr>
						<tr><td>Email: </td><td><input type="email" class="form-control" placeholder="Enter Email" name="cemail" id="inputDefault" required/></td></tr>
						<tr><td>Contact Number: </td><td><input type="int" class="form-control" placeholder="Enter Contact Number" name="ccontact" id="inputDefault"required/></td></tr>
						<tr><td>Birthday: </td><td><input type="date" class="form-control" name="cbday" id="inputDefault" required/></td></tr>
						<tr><td>Username: </td><td><input type="text" class="form-control" placeholder="Enter Username" name="cuname" id="inputDefault" required/></td></tr>
						<tr><td>Password: </td><td><input type="password" class="form-control" placeholder="Enter Password" name="cpword" id="inputDefault" required/></td></tr>
						<tr><td>Confirm Password: </td><td><input type="password" class="form-control" placeholder="Enter Confirm Password" name="ccpword" id="inputDefault" required/></td></tr>
						<input type="hidden" value="no_photo.jpg" name="img">
						<tr><td></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button name="clerk" class="btn btn-primary">Submit</button></td></tr>
						</tbody>';
					echo '
						</table></form>
					</div>';	
					echo '<div class="tab-pane fade" id="display">';
